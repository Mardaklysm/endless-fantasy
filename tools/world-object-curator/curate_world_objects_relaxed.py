...
DEFAULT_CHOICES: list[dict[str, Any]] = [
    ...
    choice("town_harbor_01", SETTLEMENT_A, 2, 3, "harbor_poi", "harbor_town", "harbor_poi", "primary harbor-town POI", "Attached docks and buildings make the port role immediately legible without needing old atlas art.", ["settlement", "harbor", "port"], "location:brinewick"),
    ...
    choice("fortress_snowy_01", SETTLEMENT_A, 5, 8, "castle_poi", "snowy_fortress", "fortification_poi", "snow fortress POI", "Snow and wall silhouette make a useful cold-region fortress.", ["fortress", "snow"], "available:snow_fortress"),
    ...
    choice("blacksmith_workshop_01", SETTLEMENT_A, 8, 2, "commercial_poi", "blacksmith", "settlement_poi", "smithy building POI", "Glowing forge silhouette makes it clearly distinct from generic houses.", ["blacksmith", "shop"], "available:blacksmith"),
    ...
    choice("village_docks_blue_01", SETTLEMENT_B, 1, 5, "harbor_poi", "blue_dock_village", "harbor_poi", "blue-roof harbor village variant", "Compact waterfront settlement with clear dock identity.", ["settlement", "harbor", "village"], "available:harbor"),
    ...
    choice("town_harbor_dense_01", SETTLEMENT_B, 2, 3, "harbor_poi", "dense_harbor_town", "harbor_poi", "dense harbor town variant", "Dense port block gives a more urban harbor option.", ["settlement", "harbor", "town"], "available:harbor"),
    ...
    choice("shipyard_boathouse_01", SETTLEMENT_B, 6, 4, "harbor_poi", "shipyard_boathouse", "harbor_poi", "boathouse shipyard variant", "Boathouse and pier produce a clear harbor-industry POI.", ["shipyard", "boathouse"], "available:shipyard"),
    ...
    choice("dockyard_cranes_02", SETTLEMENT_B, 6, 7, "harbor_poi", "dockyard_cranes", "harbor_poi", "dockyard cranes variant", "Cranes are distinct from simple docks and strengthen port visuals.", ["dockyard", "crane"], "available:dockyard"),
    choice("stone_bridge_single_01", SETTLEMENT_B, 7, 2, "bridge", "single_stone_bridge", "infrastructure", "single stone bridge stamp", "A clean bridge variant for route art without old atlas dependencies.", ["bridge", "stone"], "available:bridge"),
    choice("stone_bridge_wide_01", SETTLEMENT_B, 7, 3, "bridge", "wide_stone_bridge", "infrastructure", "wide stone bridge stamp", "Wide bridge variant can support larger crossings or major roads.", ["bridge", "stone"], "available:bridge"),
    choice("gatehouse_toll_01", SETTLEMENT_B, 7, 5, "travel_infrastructure", "toll_gatehouse", "infrastructure", "toll gatehouse POI", "Gatehouse plus barrier is a compact route checkpoint.", ["gatehouse", "checkpoint"], "available:gatehouse"),
    ...
    choice("castle_coastal_keep_01", SETTLEMENT_C, 5, 8, "castle_poi", "coastal_keep", "fortification_poi", "coastal castle POI", "Castle on compact shoreline base is valid as a coastal fortification marker.", ["castle", "coastal"], "available:castle"),
    ...
    choice("gate_dark_fortress_02", DUNGEON_NEW, 2, 6, "fort_poi", "dark_fortress_gate", "fortification_poi", "dark fortress gate variant", "Clean dark gate strengthens fortress/gate POI choices.", ["gate", "dark", "fortress"], "available:gate"),
    ...
    choice("fortress_dark_gate_01", DUNGEON_NEW, 8, 8, "fort_poi", "dark_gate_fortress", "fortification_poi", "dark endgame fortress gate", "Tall dark gate is clean and useful as a fortress/final variant.", ["gate", "dark", "fortress"], "available:gate"),
    choice(
...
OBJECT_MAPPINGS = {
    "harbor_signpost": "town_harbor_01",
    "travel_flag_marker": "gatehouse_toll_01",
    ...
    "cursed_fortress_gate": "gate_dark_fortress_02",
}
