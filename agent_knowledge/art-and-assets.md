...
- Active current overworld objects: 80 approved 256x256 transparent PNG object sprites in `src/assets/world/current/objects/`, selected from `D:\new_items` and additive raw sources in `D:\Tools\rembg\bg_input`.
