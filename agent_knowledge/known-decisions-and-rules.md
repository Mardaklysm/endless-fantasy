...
- Do not reintroduce runtime map-level seam blending, same-tile seam softening, water seam blending, intersection/corner softening, or cached-pixel mutation for stamped `atlas_v3` tile maps. The accepted transition direction is semantic mask/field rendering with code-drawn shallow water, beaches, coastline foam/tint, and grass/sand/ice edge softening, not a giant transition tile atlas.
