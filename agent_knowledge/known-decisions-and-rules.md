...
- Roads, beaches/coasts, shallow water, forests/jungle, and volcanic support have active `atlas_v3` terrain cells. Harbor dock/bridge markers use `src/assets/world/pier_atlas.png` with generated fallback drawing if the texture is missing.
