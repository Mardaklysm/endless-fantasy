...
- Do not randomly stamp fixed-orientation coast or foam tiles (`grass_sand_coast`, `sand_water_edge`, `sand_water_corner`, `cove_coast`, `foamy_shallow_water`) in world generation unless direction-aware placement is implemented. Use simple beach/wet beach and simple shallow water for now.
...
- Dungeon and town atlas floors/walls should use weighted base/accent selection. Small dungeon maps should be centered in the viewport, and dungeon `#` filler should render as void unless it borders carved playable space.
