...
- Palm groves, pine groves, and normal broadleaf groves should be clustered/zone-based and spatially separated, not isolated random single trees. Runtime forest overlays choose one object family per connected semantic grove based on island theme/biome and place one normal unscaled tree sprite on every semantic forest cell; avoid mixing palms and broadleaf trees inside the same grove unless a future explicit transition biome is added.
