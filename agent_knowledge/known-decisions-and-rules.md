...
- Exploration movement is tile-anchor based: accepted input moves from one tile center to the next, and releasing input finishes the active step before stopping.
