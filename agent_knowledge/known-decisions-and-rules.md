...
- The active overworld is an ocean archipelago with at least three islands: Greenhaven, Coralreach, and Ashfang Isle. The generator tracks island metadata, island tile maps, towns, harbors, dungeons, landmarks, roads, shallow-water overlays, sea routes, reefs/details, and dock/bridge markers.
- The active atlas does not provide distinct tiles for every requested terrain concept. Use atlas-v3-safe fallbacks and overlays rather than adding external assets: sand for beaches, trampled grass for roads, dark/lush grass for forest hooks, deep water plus overlay coordinates for shallow water, and marker/fallback shapes for harbors/landmarks.
