...
- The overworld terrain atlas is imported from `C:\Users\Marku\Downloads\redo_this_please_2K_202606182350.jpeg` by `tools/art_import/import_world_atlas.mjs`. The source is copied to `src/assets/world/source/`, normalized to `src/assets/world/world_atlas.normalized.png`, and described by `src/data/worldTiles.ts`.
