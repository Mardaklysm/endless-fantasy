...
- Road semantic paths render in normal gameplay through styled procedural stroke overlays; inspect graph nodes/source/mouth diagnostics through F6 debug modes. River bodies render from semantic river masks through the current freshwater asset tile renderer, with cardinal connectivity selecting atlas cells. Unbridged rivers block walking, while road-river bridge candidates remain walkable and render bridge/crossing stamps. Future river polish should add dedicated directional river tile cells or edge masks, not blue stroke/tube rendering.
