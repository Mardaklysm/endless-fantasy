...
- Runtime overworld terrain now uses a generated semantic mask/field background texture for shallow-water halos, beaches, coastline tint/foam, and softened grass/sand/ice edges. Future polish should tune the procedural color/noise palettes and eventually add brush-style assets, not hundreds of coastline transition tiles.
