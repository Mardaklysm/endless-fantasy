...
- Runtime overworld terrain now uses a generated semantic background texture with crisp procedural fills for water/beach/grass/sand/ice and narrow edge-only pixel overlays for shallow-water halos, coastline tint/foam, and grass/sand/ice boundaries. Future polish should tune the procedural color/noise palettes and eventually add brush-style assets, not hundreds of coastline transition tiles.
