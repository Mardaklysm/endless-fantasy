...
- Road and river semantic paths now render in normal gameplay through styled procedural stroke overlays; inspect graph nodes/source/mouth diagnostics through F6 debug modes. Rivers have a first banked-brush polish pass with curved muted strokes, pools, and flecks. Future route polish should tune the brush further, add small bridge stamps, or improve crossings rather than creating giant road/river atlases.
