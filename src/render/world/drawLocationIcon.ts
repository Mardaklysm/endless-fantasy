import { LAYER_OBJECT_IMAGE, TILE } from "../../app/config";
import type { AssetKey } from "../../assets/assetTypes";
import { LOCATION_TEXTURES } from "../../assets/textureKeys";
import type { LocationDef } from "../../data/gameDataTypes";
import { worldCurrentAssetByTextureKey, worldCurrentPoiTextureKeyFor } from "../../data/worldCurrentAssets";
import type { WorldCurrentAssetRecord } from "../../data/worldCurrentAssets";
import type { WorldPoiKind } from "../../world/worldGenerator";
