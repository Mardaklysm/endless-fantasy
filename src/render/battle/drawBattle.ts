...
function drawVictoryRewardCard(
  ...
  this.ui.fillStyle(0x071225, 0.68).fillRect(x, y, w, 38);
  this.ui.fillStyle(0xffffff, 0.035).fillRect(x + 2, y + 2, w - 4, 11);
  this.ui.lineStyle(1, BATTLE_UI.gold, 0.62).strokeRect(x, y, w, 38);
