import {
  GENERIC_WORLD_TILE_IDS as CLASSIC_WORLD_TILE_IDS,
  GENERIC_WORLD_TILES as WORLD_TILES,
  genericIsWorldTileWalkable as isWorldTileWalkable,
  genericWorldTileEncounterFamily as worldTileEncounterFamily,
  genericWorldTileHasTag as worldTileHasTag,
  genericWorldTileIdsMatching as worldTileIdsMatching,
  genericWorldTileMovementCost as worldTileMovementCost,
  type GenericWorldBiome as WorldBiome,
  type GenericWorldEncounterFamily as WorldEncounterFamily,
  type GenericWorldTileId as WorldTileId,
} from "./genericAtlasWorldCatalog.ts";
