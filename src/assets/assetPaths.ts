...
export const ASSET_PATHS = [
  ...
  ["enemy_green_wolf", "enemies/common/green_wolf.png"],
  ["enemy_bandit", "enemies/common/bandit.png"],
  ["enemy_reef_crab", "enemies/common/reef_crab.png"],
  ["enemy_jungle_shaman", "enemies/common/jungle_shaman.png"],
  ["enemy_ash_golem", "enemies/common/ash_golem.png"],
  ["enemy_sea_serpent", "enemies/common/sea_serpent.png"],
...
export const DUNGEON_TILE_ASSET_MODULES = import.meta.glob("./world/dungeon_tiles/*.png", {
  eager: true,
  query: "?url",
  import: "default"
}) as Record<string, string>;
